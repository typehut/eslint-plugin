...
const isDOMElement =
  require("eslint-plugin-jsx-a11y/lib/util/isDOMElement").default;
const isHiddenFromScreenReader =
  require("eslint-plugin-jsx-a11y/lib/util/isHiddenFromScreenReader").default;
const isInteractiveElement =
  require("eslint-plugin-jsx-a11y/lib/util/isInteractiveElement").default;
const isInteractiveRole =
  require("eslint-plugin-jsx-a11y/lib/util/isInteractiveRole").default;
const mayHaveAccessibleLabel =
  require("eslint-plugin-jsx-a11y/lib/util/mayHaveAccessibleLabel").default;
...
const meta = {
  docs: {
    ...
    recommended: false,
    url: "https://github.com/typehut/eslint-plugin/blob/main/docs/rules/jsx-a11y-control-has-associated-label.md",
  },
