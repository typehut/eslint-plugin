...
const hasAccessibleChild =
  require("eslint-plugin-jsx-a11y/lib/util/hasAccessibleChild").default;
...
const meta = {
  docs: {
    ...
    recommended: false,
    url: "https://github.com/typehut/eslint-plugin/blob/main/docs/rules/jsx-a11y-anchor-has-content.md",
  },
