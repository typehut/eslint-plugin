...
module.exports = {
    ...
    create: context => ({
        JSXOpeningElement: node => {
            ...
            const ignoreAttributeInnerOptions = options.ignoreAttributeInner === false ? options.ignoreAttributeInner : true;
            const attributeTracingDepthOptions = options.attributeTracingDepth || 4;
            ...
            if (ignoreAttributeInnerOptions && findAncestor(node, (parent => parent.type === "JSXAttribute"), attributeTracingDepthOptions)) {
                return;
            }
