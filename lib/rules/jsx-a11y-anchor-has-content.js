 ...
 */
const errors = {
    enforceAnchorHasContent: "Anchors must have content and the content must be accessible by a screen reader."
};
...
function create(context) {
    return {
        JSXOpeningElement: node => {
            ...
            if (ignoreAttributeInner && findAncestor(node, (parent => t.isJSXAttribute(parent)), attributeTracingDepth)) {
                return;
            }
