...
const meta = {
  docs: {
    ...
    recommended: true,
    url: "https://github.com/typehut/eslint-plugin/blob/main/docs/rules/func-style.md",
  },
...
function create(context) {
  const PREFIX_COLON = /^:\s*/u,
    ...
    topLevelStyle = context.options[1]
      ...
      : style,
    onlyTopLevel = context.options[1] ? context.options[1].onlyTopLevel : false,
    enforceDeclarations = !onlyTopLevel && style === "declaration",
    enforceArrows = !onlyTopLevel && style === "arrow",
    enforceExpressions = !onlyTopLevel && style === "expression",
